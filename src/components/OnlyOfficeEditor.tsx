            ...
            <DocumentEditor
                ...
                config={{
                    ...
                    editorConfig: {
                        ...
                        callbackUrl: `https://disclosure-pretty-nominations-cad.trycloudflare.com/api/v1/documents/save-editor/${localStorage.getItem("accessToken")}`, // URL để nhận sự kiện "save" từ OnlyOffice
                        customization: {
